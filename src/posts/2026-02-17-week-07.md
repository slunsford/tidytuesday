...
I went with the obvious one and put the total population of sheep, cattle, pigs, and poultry on a chart. (Most of my investment this week was developing this [time-series line chart](https://uncharted.seanlunsford.com/chart-types/#time-series-charts) for [Uncharted](https://uncharted.seanlunsford.com/)—plus [integrating](https://uncharted.seanlunsford.com/features/#icon-support) [Font Awesome](https://fontawesome.com/) for the icons.)
...
<style>
  .chart-series-cattle { --color: var(--chart-color-gray); }
  .chart-series-sheep { --color: var(--chart-color-yellow); }
  .chart-series-pigs { --color: var(--chart-color-pink); }
  .chart-series-poultry { --color: var(--chart-color-orange); }
</style>
