...
The [first curated dataset](https://github.com/rfordatascience/tidytuesday/blob/main/data/2026/2026-01-13/readme.md) for 2026 is languages of Africa, including language family, country, and speaker count.
...
…502 languages. That looked like an unreadable cluster in the lower left with a handful of dots scattered around the rest (most notably Arabic, spoken natively by 1.8 billion people across 12 countries).

After thinking about it for a mintue, I actually wanted to zoom in on the ones closest to zero—the ones spoken by the fewest people. There's no defined threshold for an [endangered language](https://en.wikipedia.org/wiki/Endangered_language), but 1000 left me with 26 languages and is a nice round number.
